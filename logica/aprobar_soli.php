...
if(!empty($_POST)){
    ...
    try {
       ...
       // $mail->SMTPDebug = 0;                    //Enable verbose debug output
        ...
        //Recipients
        $mail->setFrom('RosarioION1936@gmail.com', 'Solicitud Expediente Médico');
        ...
        $mail->Body    = 'Su Solicitud de Expediente Médico fue aprobada, comuniquese lo mas pronto posible al Insituto Oncológico Nacional.';
