...
<head>
    ...
    <title>Servicio de Quimioterapia</title>
    ...
    <div class="soli-container">
        ...
        <div class="card mb-3 " style="max-width: 12000px;">
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body">
                <h5 class="card-title ">Servicio de Quimioterapia</h5>
                <p class="card-text texto Izquierda">Si deseas visualizar el turno de Quimioterapia en tiempo real , sigue los siguientes pasos:</p>
                <p class="texto Izquierda"> Paso 1: Ingresar al sitio web del ION <br>
                   Paso 2: Una vez dentro del mismo, ubicar la pestaña de Servicios - Quimioterapia<br>
                   Paso 3: El sistema te mostrara la posición actual y tu posición asignada <br>
                   Nota: Este servicio solo se puede acceder si usted tiene una cita en Quimioterapia</p>
              </div>
            </div>
          </div>
      </div>
